...
public class PlacesActivity extends Activity {
	...
	/**
	 * Checks the current fine location permission state of the device.
	 * <ol>
	...
	/**
	 * Call this method to request access for fine location permission from the user.
	 * <ol>
	...
	/**
	 * Lifecycle method for Places Activity
	 */
	@Override
	...
	/**
	 * Permission Handler method called when the user has given permission to access fine location.
	 */
	...
	/**
	 * Permission Handler method called when the user has denied permission to access fine location.
	 */
	...
	/**
	 * Permission handler method for Invalid Request Code.
	 * <p>
	 * This method is called when permission request code obtained doesn't match with the permission request code
	 ...
	 * <p>
	 * This method is called when shouldShowRequestPermissionRationale returns "true",
	 * which mean when the application was launched earlier and the user had "denied" the permission in last launch WITHOUT checking "never show again".
	 */
