...
public class PlacesMonitorListenerMonitorRequestContentTests {
    ...
    public void beforeEach() {
        listener = new PlacesMonitorListenerMonitorRequestContent(extensionApi, PlacesMonitorTestConstants.EventType.MONITOR, PlacesMonitorTestConstants.EventSource.REQUEST_CONTENT);
    ...
    public void testHear_WithNullEventData() {
        // setup
        Event event = new Event.Builder("testEvent", PlacesMonitorTestConstants.EventType.MONITOR, PlacesMonitorTestConstants.EventSource.REQUEST_CONTENT).setData(null).build();
    ...
    public void testHear_WithNullParentExtension() {
        ...
        Event event = new Event.Builder("testEvent", PlacesMonitorTestConstants.EventType.MONITOR, PlacesMonitorTestConstants.EventSource.REQUEST_CONTENT).setData(eventData).build();
    ...
    public void testHear_ValidEvent_Then_QueuesAndProcessesEvent() {
        ...
        EventData eventData = new EventData();
        eventData.putString("dummyKey", "dummyValue");
        Event event = new Event.Builder("testEvent", PlacesMonitorTestConstants.EventSource.REQUEST_CONTENT, PlacesMonitorTestConstants.EventType.MONITOR).setData(eventData).build();
